...
| `GET /projects/{project_id}/database/tables/{table}/export` | project member | Download a full table (`?format=csv\|xlsx\|parquet\|sav`) |
...
Report artifacts generated by analysis runs and stored in the project repository.
