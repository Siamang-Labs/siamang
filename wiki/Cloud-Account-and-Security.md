...
Open them from the **account menu** in the top bar → **Profile**. Profile has these
tabs: **Account**, **Security**, **Appearance**, **API keys**, **SSH keys**, and
**Support**.
...
Locked out? You can reset your password from the sign-in screen without being
logged in.

**Steps**
1. On the sign-in screen, enter your email and click **Forgot password?**.
2. Click **Send reset link** and check your inbox.
3. Open the email and follow the link back to siamang Cloud.
4. Enter a **new password** twice and submit.

**Result:** your password is updated and you can sign in with it. Password sign-in
and reset are for email accounts; if you sign in with **GitHub**, manage your
password at GitHub.

## Appearance

The **Appearance** tab switches between **light** and **dark** theme. This is now
the only place to change the theme (it was removed from the top bar).
...
The **Support** tab in your Profile is the help hub:

- **Contact the team** for help with your account, repositories, organizations, or
  billing.
- **Documentation** — open the API reference, examples, and this wiki.
