...
When you create a project you choose how it starts — three options:
...
- **Example** — the complete **"Digital Life & Wellbeing 2026"** study: a full
  ...
  **Pick this for your first project** — you can see the whole loop before writing
  anything.
- **Template** — a minimal survey plus two starter analysis scripts (cleaning and
  final tables), with no sample data. A tidy starting point for a real study.
- **Empty** — a one-question starter survey plus the project scaffold
  (`scripts/`, `outputs/`, `reports/`), and nothing else.
...
1. Open **Projects**.
2. Click **New project**.
3. Enter a **name**, then choose how to start — **Empty**, **Template**, or
   **Example** (Example is recommended for your first project).
4. Click **Create**.
