...
consent = Variable(
    "consent",
    scale="nominal",
    label="Consent to take part",
    labels={1: "Yes, I agree", 2: "No, not now"},
)
age = Variable("age", scale="ratio", label="Age in years", role="input", valid_range=(13, 99))
gender = Variable(
    "gender",
    scale="nominal",
    label="Gender",
...
age_group = Variable(
    "age_group", scale="ordinal", label="Age group", labels={1: "16-29", 2: "30-44", 3: "45+"}
)
region = Variable(
    "region",
    scale="nominal",
    label="Type of area",
    labels={1: "City center", 2: "Suburbs", 3: "Small town", 4: "Rural"},
)
employment = Variable(
    "employment",
    scale="nominal",
    label="Employment status",
    labels={1: "Full-time", 2: "Part-time", 3: "Self-employed", 4: "Student", 5: "Not working"},
)
work_mode = Variable(
    "work_mode",
    scale="nominal",
    label="Current work mode",
    labels={1: "Fully remote", 2: "Hybrid", 3: "On-site"},
)
commute_minutes = Variable(
    "commute_minutes", scale="ratio", label="One-way commute (minutes)", valid_range=(0, 240)
)

owns_smartphone = Variable(
    "owns_smartphone", scale="nominal", label="Owns a smartphone", labels=YESNO
)
owns_laptop = Variable("owns_laptop", scale="nominal", label="Owns a laptop", labels=YESNO)
owns_tablet = Variable("owns_tablet", scale="nominal", label="Owns a tablet", labels=YESNO)
owns_smartwatch = Variable(
    "owns_smartwatch", scale="nominal", label="Owns a smartwatch", labels=YESNO
)
primary_device = Variable(
    "primary_device",
    scale="nominal",
    label="Most-used device",
    labels={1: "Smartphone", 2: "Laptop", 3: "Tablet", 4: "Smartwatch"},
)

social_freq = Variable(
    "social_freq",
    scale="ordinal",
    label="Social media use",
    labels={1: "Never", 2: "Weekly", 3: "Daily", 4: "Many times a day"},
)
doomscroll = Variable(
    "doomscroll", scale="ordinal", label="I scroll longer than I meant to", labels=AGREE5
)
news_source = Variable(
    "news_source",
    scale="nominal",
...
trust_news = Variable(
    "trust_news", scale="ordinal", label="I trust most of the news I see", labels=AGREE5
)
screen_time_hours = Variable(
    "screen_time_hours", scale="ratio", label="Screen time (hours/day)", valid_range=(0, 24)
)
manage = Variable(
    "manage",
    scale="nominal",
...
feel_rested = Variable("feel_rested", scale="ordinal", label="Wake up rested", labels=FREQ5)
can_focus = Variable("can_focus", scale="ordinal", label="Focus without my phone", labels=FREQ5)
feel_anxious = Variable(
    "feel_anxious", scale="ordinal", label="Anxious about messages", labels=FREQ5
)
in_control = Variable(
    "in_control", scale="ordinal", label="In control of my screen time", labels=FREQ5
)
sleep_quality = Variable("sleep_quality", scale="ordinal", label="Sleep well", labels=FREQ5)
life_satisfaction = Variable(
    "life_satisfaction", scale="ordinal", label="Overall life satisfaction"
)
disconnect_rank = Variable(
    "disconnect_rank",
    scale="nominal",
...
nps = Variable(
    "nps", scale="interval", label="Likelihood to try a digital detox (0-10)", valid_range=(0, 10)
)
improve = Variable("improve", scale="nominal", label="One change to your digital life")
recontact = Variable(
    "recontact", scale="nominal", label="Open to a follow-up", labels={1: "Yes", 2: "No"}
)
...
survey = Questionnaire(
    ...
    pages=[
        ...
        Page(
            ...
            items=[
                SingleChoice(
                    "Do you agree to take part?", consent, required=True, display="buttons"
                ),
            ],
        ),
        ...
        DisqualificationPage(
            ...
            show_if=age.lt(16),
            body=(
                "<p>This study is for people aged 16 and over, so we cannot "
        ...
        Page(
            ...
            items=[
                ...
                SingleChoice("Which best describes your area?", region, display="dropdown"),
            ],
        ),
        Page(
            "work",
            title="Work & study",
            items=[
                SingleChoice("What is your current situation?", employment, required=True),
            ],
        ),
                ...
                Block(
                    ...
                    items=[
                        ...
                        MultiChoice(
                            ...
                            vars=[owns_smartphone, owns_laptop, owns_tablet, owns_smartwatch],
                        ),
                    ],
                ),
                Block(
                    ...
                    items=[
                        ...
                        SingleChoice(
                            ...
                            choices=[
                                ...
                                Option(2, "Laptop"),
                                Option(3, "Tablet"),
                                Option(4, "Smartwatch", show_if=owns_smartwatch.eq(1)),
                            ],
                        ),
                    ],
                ),
            ...
            items=[
                Block(
                    ...
                    items=[
                        ...
                        LikertScale(
                            "I scroll for longer than I intended",
                            doomscroll,
                            points=5,
                            left_label="Disagree",
                            right_label="Agree",
                ...
                Block(
                    ...
                    items=[
                        ...
                        LikertScale(
                            "I trust most of the news I see",
                            trust_news,
                            points=5,
                            left_label="Disagree",
                            right_label="Agree",
        ...
        Page(
            ...
            items=[
                NumericInput(
                    "On a typical day, how many hours on screens?",
                    screen_time_hours,
                    display="slider",
                    unit="h/day",
                    step=1,
                ...
                MultiChoice(
                    "What do you do to manage your screen time?",
                    manage,
        ...
        Page(
            ...
            items=[
                ...
                Matrix(
                    "How often does each apply to you?",
                    var=[feel_rested, can_focus, feel_anxious, in_control, sleep_quality],
                    column_labels=["Never", "Rarely", "Sometimes", "Often", "Always"],
                ),
                LikertScale(
                ...
                Ranking(
                    "Rank what helps you disconnect (most helpful first)",
                    disconnect_rank,
                    max_ranked=5,
                ),
            ],
        ...
        Page(
            ...
            items=[
                NumericInput(
                    "How likely are you to try a digital detox? (0-10)",
                    nps,
                    display="slider",
                    step=1,
                ),
                OpenText(
                    "If you could change one thing about your digital life, what would it be?",
                    improve,
                    multiline=True,
                    max_chars=400,
                ...
                SingleChoice(
                    "Happy for us to contact you about a follow-up?", recontact, display="buttons"
                ),
            ],
        ),
        ...
        FinalPage(
            ...
            title="Thank you",
            body=(
                "<h3>All done</h3><p>Your answers were recorded and are "
